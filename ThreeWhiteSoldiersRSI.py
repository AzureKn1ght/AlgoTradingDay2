# https://www.quantconnect.com/reports/82b3142d5add2ee2087d6ace263f1043

class ThreeWhiteSoldiersRSI(QCAlgorithm):
    ...
    def OnData(self, data):
        ...
        if self.rsi.IsReady:
            ...
            if self.back_1 > self.back_2 and self.current > self.back_1 and self.rsi.Current.Value<70:
