# TODO: add short sell function 

class ThreeWhiteSoldiersRSIandMACD_Multi(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.curr = ["EURUSD","EURGBP","EURCHF"]
        self.rsi = {}
        self.macd = {}
        self.back_1 = {}
        self.back_2 = {}
        ...
        for i in self.curr:
            ...
            self.macd[i] = self.MACD(i, 12, 26, 9, MovingAverageType.Exponential, Resolution.Daily)
            self.back_1[i]= None
            self.back_2[i] = None
            self.current[i] = None
    ...
    def OnData(self, data):
        ...
        for currency in self.curr:
            ...
            if self.rsi[currency].IsReady and self.macd[currency].IsReady:
                ...
                self.rsi[currency].Current.Value < 70 and  ( self.macd[currency].Current.Value > self.macd[currency].Signal.Current.Value) : 
